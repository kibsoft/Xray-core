...
const (
	...
	RoutingService_AddFallbackRule_FullMethodName        = "/xray.app.router.command.RoutingService/AddFallbackRule"
	RoutingService_RemoveFallbackRule_FullMethodName     = "/xray.app.router.command.RoutingService/RemoveFallbackRule"
	RoutingService_GetRoutingMode_FullMethodName         = "/xray.app.router.command.RoutingService/GetRoutingMode"
)
...
type RoutingServiceClient interface {
	...
	AddFallbackRule(ctx context.Context, in *AddFallbackRuleRequest, opts ...grpc.CallOption) (*AddFallbackRuleResponse, error)
	RemoveFallbackRule(ctx context.Context, in *RemoveFallbackRuleRequest, opts ...grpc.CallOption) (*RemoveFallbackRuleResponse, error)
	GetRoutingMode(ctx context.Context, in *GetRoutingModeRequest, opts ...grpc.CallOption) (*GetRoutingModeResponse, error)
}
...
func (c *routingServiceClient) AddFallbackRule(ctx context.Context, in *AddFallbackRuleRequest, opts ...grpc.CallOption) (*AddFallbackRuleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddFallbackRuleResponse)
	err := c.cc.Invoke(ctx, RoutingService_AddFallbackRule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingServiceClient) RemoveFallbackRule(ctx context.Context, in *RemoveFallbackRuleRequest, opts ...grpc.CallOption) (*RemoveFallbackRuleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RemoveFallbackRuleResponse)
	err := c.cc.Invoke(ctx, RoutingService_RemoveFallbackRule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingServiceClient) GetRoutingMode(ctx context.Context, in *GetRoutingModeRequest, opts ...grpc.CallOption) (*GetRoutingModeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetRoutingModeResponse)
	err := c.cc.Invoke(ctx, RoutingService_GetRoutingMode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RoutingServiceServer interface {
	...
	AddFallbackRule(context.Context, *AddFallbackRuleRequest) (*AddFallbackRuleResponse, error)
	RemoveFallbackRule(context.Context, *RemoveFallbackRuleRequest) (*RemoveFallbackRuleResponse, error)
	GetRoutingMode(context.Context, *GetRoutingModeRequest) (*GetRoutingModeResponse, error)
...
func (UnimplementedRoutingServiceServer) AddFallbackRule(context.Context, *AddFallbackRuleRequest) (*AddFallbackRuleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddFallbackRule not implemented")
}
func (UnimplementedRoutingServiceServer) RemoveFallbackRule(context.Context, *RemoveFallbackRuleRequest) (*RemoveFallbackRuleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveFallbackRule not implemented")
}
func (UnimplementedRoutingServiceServer) GetRoutingMode(context.Context, *GetRoutingModeRequest) (*GetRoutingModeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRoutingMode not implemented")
}
...
func _RoutingService_AddFallbackRule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddFallbackRuleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoutingServiceServer).AddFallbackRule(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingService_AddFallbackRule_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoutingServiceServer).AddFallbackRule(ctx, req.(*AddFallbackRuleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RoutingService_RemoveFallbackRule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveFallbackRuleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoutingServiceServer).RemoveFallbackRule(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingService_RemoveFallbackRule_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoutingServiceServer).RemoveFallbackRule(ctx, req.(*RemoveFallbackRuleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RoutingService_GetRoutingMode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRoutingModeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoutingServiceServer).GetRoutingMode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingService_GetRoutingMode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoutingServiceServer).GetRoutingMode(ctx, req.(*GetRoutingModeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RoutingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddFallbackRule",
			Handler:    _RoutingService_AddFallbackRule_Handler,
		},
		{
			MethodName: "RemoveFallbackRule",
			Handler:    _RoutingService_RemoveFallbackRule_Handler,
		},
		{
			MethodName: "GetRoutingMode",
			Handler:    _RoutingService_GetRoutingMode_Handler,
		},
	},
